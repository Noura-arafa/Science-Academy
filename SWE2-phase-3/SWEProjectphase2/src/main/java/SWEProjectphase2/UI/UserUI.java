...
@CrossOrigin(origins = "http://localhost:8090")
@RequestMapping(method=RequestMethod.GET,value="/shownotification/{useremail}")
public ArrayList<String> shownotification(@PathVariable String useremail){
	System.out.println("the user name "+useremail); 
	 return userservice.shownotification(useremail);
}
